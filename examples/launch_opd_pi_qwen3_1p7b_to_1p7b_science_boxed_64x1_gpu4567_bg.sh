...
TEACHER_MODEL="/idfsdata/yexuyan/OPD/models/Qwen3-1.7B"
...
RAY_DASHBOARD_AGENT_LISTEN_PORT="52580"
RAY_DASHBOARD_AGENT_GRPC_PORT="52581"
RAY_RUNTIME_ENV_AGENT_PORT="52582"
RAY_METRICS_EXPORT_PORT="52583"
CURRENT_USER="$(whoami)"
...
RUN_ID="opd_pi_qwen3_1.7b_to_1p7b_science_boxed_64x1_gpu4567"
...
(
  ...
  echo "Cleaning only ${CURRENT_USER}'s processes on GPUs 4,5,6,7 and ports ${TEACHER_PORT}/${RAY_PORT}/${RAY_DASHBOARD_PORT}/${RAY_DASHBOARD_AGENT_LISTEN_PORT}/${RAY_DASHBOARD_AGENT_GRPC_PORT}/${RAY_RUNTIME_ENV_AGENT_PORT}/${RAY_METRICS_EXPORT_PORT}..."
